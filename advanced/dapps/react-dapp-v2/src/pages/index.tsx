...
const Home: NextPage = () => {
  ...
  const handleRequiredChainSelectionClick = (chainId: string) => {
  ...
  const handleOptionalChainSelectionClick = (chainId: string) => {
    if (optionalChains.includes(chainId)) {
      setOptionalChains(optionalChains.filter((chain) => chain !== chainId))
    } else {
      setOptionalChains([...optionalChains, chainId])
    }
  }
            ...
            <div>
              ...
              {chainOptions.map((chainId) => (
                <Blockchain
                  ...
                  chainId={chainId}
                  chainData={chainData}
                  onClick={handleRequiredChainSelectionClick}
            ...
            <div>
              ...
              {chainOptions.map((chainId) => (
                <Blockchain
                  ...
                  chainId={chainId}
                  chainData={chainData}
                  onClick={handleOptionalChainSelectionClick}
                  active={optionalChains.includes(chainId)}
                />
              ))}
            </div>
          </SChainsContainer>
