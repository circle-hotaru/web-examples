...
export function ClientContextProvider({
  ...
  const [optionalChains, setOptionalChains] = useState<string[]>([])
  ...
  const onSessionConnected = useCallback(
    async (_session: SessionTypes.Struct) => {
      ...
      setOptionalChains(allNamespaceChains)
  ...
  const connect = useCallback(
    async (pairing: any) => {
      ...
      try {
        ...
        const optionalNamespaces = getOptionalNamespaces(optionalChains)
        console.log(
    ...
    [chains, optionalChains, client, onSessionConnected]
  )
